...
int main()
{
	...
	// -------------------------
	Shader tess("..\\shaders\\PNVert.vs", "..\\shaders\\phongDirFrag.fs", "..\\shaders\\Norms.gs", "..\\shaders\\PNTessC.tcs", "..\\shaders\\PNTessE.tes"); // wire


	//to load model - put a a model in resources folder
	//Model lowPolyModel("..\\resources\\Isco.obj");
